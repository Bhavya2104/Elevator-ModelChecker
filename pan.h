...
#define PanSource	"Elevator3.pml"
...
#define _nstates8	14	/* p7 */
#define minseq8	278
#define maxseq8	290
#define _endstate8	13

#define _nstates7	11	/* p6 */
#define minseq7	268
#define maxseq7	277
...
#define _nstates5	12	/* p4 */
#define minseq5	244
#define maxseq5	254
#define _endstate5	11

#define _nstates4	11	/* p2 */
#define minseq4	234
#define maxseq4	243
#define _endstate4	10

#define _nstates3	7	/* p1 */
#define minseq3	228
#define maxseq3	233
#define _endstate3	6
...
#define _nstates1	113	/* Elevator */
#define minseq1	113
#define maxseq1	224
#define _endstate1	112

#define _nstates0	114	/* Input */
#define minseq0	0
#define maxseq0	112
...
#define PElevator	((P1 *)_this)
typedef struct P1 { /* Elevator */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
...
#define Air0	(sizeof(P0) - Offsetof(P0, _2_1_req_floor) - 1*sizeof(int))
